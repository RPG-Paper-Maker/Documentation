...
## Questions from Discord <a id="what-are-the-tile-size-squares-size"></a>
...
## List of YouTube tutorials <a id="what-are-the-tile-size-squares-size"></a>
...
i messed up in the previous video, so i remade it [https://youtu.be/ynVupoA5ApU](https://youtu.be/ynVupoA5ApU)[YouTube](https://www.youtube.com/)[terikumo](https://www.youtube.com/channel/UCvd_3bntrydnq5SOFfwdAHQ)[RPG Paper Maker Tutorial - Beginner: The Basics \(\#1\)](https://www.youtube.com/watch?v=ynVupoA5ApU)  
  


## Placeholder <a id="what-are-the-tile-size-squares-size"></a>

## Tutorials from Discord <a id="what-are-the-tile-size-squares-size"></a>
